...
GitHub repository : https://github.com/pc611652003/Team-Profile-Generator
...
![Application](screenshots/terminal.PNG "Testing and user input")

After user input all team members' info, the index.html will be generated, alongside the style css file
![Final Product](screenshots/teamPage.PNG "Final product - team page")